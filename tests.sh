...
python3 $MAIN -gene1 "$DATA/eIF4E1/eIF4E1.ped" -gene2 "$DATA/eIF4G1/eIF4G1.ped"
echo ""
...
python3 $MAIN -gene1 "$NEGATIVE/COX6B2/COX6B2.ped" -gene2 "$DATA/eIF4G1/eIF4G1.ped"
echo ""
...
python3 $MAIN -gene1 "$NEGATIVE/GOLGA5/GOLGA5.ped" -gene2 "$DATA/eIF4G1/eIF4G1.ped"
echo ""
...
python3 $MAIN -gene1 "$NEGATIVE/POLG/POLG.ped" -gene2 "$DATA/eIF4G1/eIF4G1.ped"
echo ""
